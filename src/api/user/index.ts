...
import type { loginFormData, ResponseData, loginResponseData, userInfoResponseData } from './type'
...
// 退出登录
export const reqLogout = () => request.post<ResponseData>(API.LOGOUT_URL)
